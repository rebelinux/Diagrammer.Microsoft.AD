...
- Update module to version 0.2.19
- Update `Diagrammer.Core` module version to 0.2.36
- This mark the last release of this tool from now on all of the diagram will be migrated to the AsBuiltReport.Microsoft.AD report
